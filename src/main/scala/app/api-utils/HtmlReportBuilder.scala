...
class HtmlReportBuilder(average: String, warning: String, alert: String, articleResultsUrl: String, liveBlogResultsUrl: String, interactiveResultsUrl: String, frontsResultsUrl: String) {
  ...
  //Page Container
  val HTML_PAGE_CONTAINER: String = "<body><div id=\"container\"> <div id=\"head\"> <h1>Current Performance of today's Interactives</h1> <p>Job started at: " + DateTime.now + "</p><p><a href=http://wpt.gu-web.net/result/160330_Q9_17W/>Click here to see full results.</a></p> </div>"
